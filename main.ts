...
export function activate(context: vscode.ExtensionContext) {
    const toolPath = path.join(context.extensionPath, 'lib/XRebirthBabyScript.Core.dll');
    ...
    context.subscriptions.push(vscode.commands.registerCommand('xbs.watch', async () => {
